<%-- 
    Document   : listCookieResults
    Created on : 25.Mar.2019, 14:10:00
...
<biznet:mainPanel viewParams="title,body">
    <jsp:attribute name="title">
        <ul class="page-breadcrumb breadcrumb"> <li>
            ...
            <li>
                <span class="title2"><spring:message code="cookies.title"/></span>
            </li>
        </ul>
    </jsp:attribute>
    <jsp:attribute name="script">
        <script type="text/javascript">
            document.title = "<spring:message code="cookies.title"/> - BIZZY";
            var oTable;
            oTable = $('#serverDatatables').dataTable({
                ...
                "columns": [
                    {
                        data: "cookieAlertResultId",
                        render: function (data, type, row) {
                            return '<input type="checkbox" class="editor-active" id="checkPhishingAlerts" value="' + data + '" >';
                        },
            ...
            function deleteAlert() {
                var alertIds = [];
                $('input[id=checkPhishingAlerts]:checked').each(function () {
    ...
    <jsp:body>
        <table width="100%" class="table table-striped table-bordered table-hover" id="serverDatatables" >
            <thead class="datatablesThead">
                <tr>
                    <th width="10px"><input type="checkbox" class="editor-active" id="selectAll" onclick="selectAll('checkPhishingAlerts');"></th>
                <th style="vertical-align: middle;"><spring:message code="editSettings.domain"/></th>
                <th style="vertical-align: middle;"><spring:message code="listKBItems.name"/></th> 
                <th style="vertical-align: middle;"><spring:message code="listIpReputation.value"/></th>
                <th style="vertical-align: middle;"><spring:message code="cookies.title"/> <spring:message code="ti.registrationDate"/></th>
