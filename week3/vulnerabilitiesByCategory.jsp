<%-- 
    Document   : vulnerabilitiesByCategory
    Created on : Jul 17, 2018, 10:47:47 AM
    Author     : iremkaraoglu
--%>
    ...
    <biznet:mainPanel viewParams="title,body">
        <jsp:attribute name="title">
            <ul class="page-breadcrumb breadcrumb"> <li>
                ...
                <li>
                    <span class="title2"><spring:message code="dashboard.categoryvulnerabilities"/></span>
                </li>
            </ul>
        ...
        <jsp:attribute name="script">   
            <script type="text/javascript">
                document.title = "<spring:message code="dashboard.categoryvulnerabilities"/> - BIZZY";
                var oTable;
                $(document).ready(function () {
                    oTable = $('#serverDatatables').dataTable({
                        ...
                        "ajax": {
                            "type": "POST",
                            "url": "loadCategoryListWithVulnerabilities.json",
                            "data": function (d) {
                ...
                $('#serverDatatables').on('click', 'td.details-extend', function () {
                    ...
                    if (row.child.isShown()) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "loadVulnerabilitiesByCategory.json",
                            "data": {
                ...
                function reportNameControl(){
                    ...
                    generateReport("getVulnerabilitiesByCategoryReport.json", obj, "<spring:message code="report.reportCreation"/>", 
        ...
        <jsp:body>
            ...
            <table width="100%" class="table table-striped table-bordered table-hover" id="serverDatatables" >
                <thead class="datatablesThead">
                    <tr>
                        <th style="width:5%;"></th>
                        <th style="vertical-align: middle; width:60%"><spring:message code="listCategories.categoryName"/></th>
